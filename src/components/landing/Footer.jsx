    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-2xl font-bold text-white mb-4">Rusindo</h3>
            <p className="mb-4">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="hover:text-white transition">Kursus Online</a></li>
              <li><a href="#" className="hover:text-white transition">Kelas Live</a></li>
              <li><a href="#" className="hover:text-white transition">Materi Belajar</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="hover:text-white transition">Partner</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p>&copy; {currentYear} Rusindo. Hak cipta dilindungi.</p>
        </div>
      </div>
    </footer>
  );
